...
function TmpGnmAnnApi(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_combined_data = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "TmpGnmAnnApi.get_combined_data",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "TmpGnmAnnApi.status",
